 ...
 * Si la operación no existe devuelve -1
 */
const operar = (operando1: number, operando2: number, operacion: Operacion): number => {  // Dos números operando con los que se van a operar, luego la operación como tal. Esto devuelve un número.
    switch(operacion) { 
        case Operacion.SUMA:
